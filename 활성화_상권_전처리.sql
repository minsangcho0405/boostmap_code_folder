...
--   - 없으면 8-2단계(구매전환율/분기별_총_유동인구_수) 부분만 조인 제외하고 실행 가능
--
-- MySQL은 PERCENTILE_CONT가 없어 PERCENT_RANK() 기반으로 근사 구현함
-- (nearest-rank 방식. 정교한 연속 percentile이 필요하면 별도 확인 요망)
-- ============================================================

-- ------------------------------------------------------------
-- STEP 0. 외식업 10종 + 골목상권·발달상권만 필터링 (관광특구·전통시장 제외)
--   439,141행 → 135,981행(외식업) → 상권구분 필터까지 적용
-- ------------------------------------------------------------
