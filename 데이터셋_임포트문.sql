...
-- 2. CSV 데이터 임포트
-- your/path는 파일이 저장된 경로로 수정하여 실행할 것
LOAD DATA LOCAL INFILE 'your/path/서울시_상권분석서비스(추정매출-상권)_2021년.csv'
...
LOAD DATA LOCAL INFILE 'your/path/서울시_상권분석서비스(추정매출-상권)_2022년.csv'
INTO TABLE raw_sales
CHARACTER SET euckr
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'your/path/서울시_상권분석서비스(추정매출-상권)_2023년.csv'
INTO TABLE raw_sales
CHARACTER SET euckr
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'your/path/서울시 상권분석서비스(추정매출-상권)_2024년.csv'
INTO TABLE raw_sales
CHARACTER SET euckr
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'your/path/서울시 상권분석서비스(추정매출-상권)_2025년+2026년_1분기.csv'
INTO TABLE raw_sales
CHARACTER SET euckr
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'your/path/서울시 상권분석서비스(길단위인구-상권).csv'
